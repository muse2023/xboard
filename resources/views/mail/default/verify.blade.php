            ...
            >
                <div
                    ...
                    <div style="font-size: 14px; line-height: 24px; color: #000000; text-align: left;">
                        <p style="font-weight:600; font-size:20px;">邮箱验证码</p>
                        <p>尊敬的 <span style="font-weight:600">BigME</span> 用户：</p>
                        <p>您的邮箱验证码为：<span style="font-weight:600; color: #4687ff;">{{$code}}</span></p>
                        <p>请在网页中填写, 完成验证。</p>
                        <p><span style="font-weight:600">注意:</span> 请在 5 分钟内进行验证。</p>
