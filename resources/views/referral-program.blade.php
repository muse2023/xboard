...
<meta property="og:title" content="推介计划 - 高速网络,企业服务 &amp; 匿名安全 高可用性服务商 | {{$title}}">
...
<a class="btn btn-primary btn-transition" href="./special-offers">了解更多</a>
</div>
</div>
...
<h2>邀请注册</h2>
<p>所有 {{$title}} 客户，均可通过分享邀请码来获取收益。将您独一无二的邀请码发给您的朋友，邀请他们使用 {{$title}}，您就可以从 {{$title}} 获得相应回报，并能够使用所得到的佣金购买 {{$title}} 服务。</p>
</div>
...
<a href="/user#/invite" class="btn btn-primary btn-transition px-6">分享邀请码</a>
</div>
</div>
...
<h4>获取更多推广提成</h4>
<p class="mb-0">您可以加入我们的《视频创作者》计划，并成为我们的推广大使，通过您的视频宣传即可获得更高的收益！ <a class="link" href="video-creator ">立即查看详情 <i class="bi-chevron-right small"></i></a></p>
</div>
</div>
</div>
