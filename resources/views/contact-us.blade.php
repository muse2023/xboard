...
<main id="content" role="main">
    ...
    <div class="container content-space-2 content-space-lg-3" id="telegram">
        ...
        <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
            <h2 class="fw-light">快来加入我们的群组</h2>
        ...
        <div class="w-lg-75 mx-lg-auto">
            <div class="row">
                <div class="col-md-6 mb-3 mb-lg-0" data-aos="fade-up">
                    ...
                    <a class="card card-transition h-100" href="https://t.me/bigme_pro" target="_blank"
