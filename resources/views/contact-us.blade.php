@include('header')
<title>联系我们 - 高速网络,企业服务 &amp; 匿名安全 高可用性服务商 | {{$title}}</title>
<meta property="og:title" content="联系我们 - 高速网络,企业服务 &amp; 匿名安全 高可用性服务商 | {{$title}}">
...
<h1 class="fw-light">联系我们</h1>
<p>我们很乐意向您提供帮助。</p>
</div>
<div class="row">
<div class="col-md-4 mb-3 mb-md-0">

<a class="card card-transition text-center h-100" href="/user#/knowledge">
<div class="card-body">
...
<h4 class="card-title">使用文档</h4>
<p class="card-text text-body">查看 {{$title}} 使用文档</p>
</div>
<div class="card-footer pt-0">
<span class="card-link">立即查看 <i class="bi-chevron-right small ms-1"></i></span>
</div>
</a>
...
<a class="card card-transition text-center h-100" href="/faq">
<div class="card-body">
<div class="svg-icon text-primary mb-3">
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<p class="card-text text-body">一些常见问题可能会对您有所帮助。</p>
</div>
<div class="card-footer pt-0">
<span class="card-link">查看常见问题 <i class="bi-chevron-right small ms-1"></i></span>
</div>
</a>
...
<!--<a class="card card-transition text-center h-100"  href="/user">-->
<a class="card card-transition text-center h-100" onclick="$crisp.push(['do', 'chat:open'])">
<div class="card-body">
<div class="svg-icon text-primary mb-3">
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<p class="card-text text-body">通过在线客服按钮，在线联系我们</p>
</div>
<div class="card-footer pt-0">
<span class="card-link">向我们提问 <i class="bi-chevron-right small ms-1"></i></span>
</div>
</a>
...
<div class="container content-space-2 content-space-lg-3" id="telegram">

<div class="w-md-80 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
<h2 class="fw-light">快来加入我们的 Telegram</h2>
<p>我们开放了公告频道和用户交流群组，您可以更快捷地了解我们的最新动态、优惠，以及更方便地向我们反馈问题。</p>
</div>
...
<a class="card card-transition h-100" href="https://t.me/bigme_pro" target="_blank" rel="noopener noreferrer">
<div class="card-body">
<div class="d-flex">
<div class="flex-shrink-0">
<span class="svg-icon text-primary">
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M10.6 10.7C13.3 8 16.9 6.3 20.9 6C21.5 6 21.9 5.5 21.9 4.9V3C21.9 2.4 21.4 2 20.9 2C15.8 2.3 11.2 4.4 7.79999 7.8C4.39999 11.2 2.2 15.8 2 20.9C2 21.5 2.4 21.9 3 21.9H4.89999C5.49999 21.9 6 21.5 6 20.9C6.2 17 7.90001 13.4 10.6 10.7Z" fill="#035A4B"></path>
<path opacity="0.3" d="M14.8 14.9C16.4 13.3 18.5 12.2 20.9 12C21.5 11.9 21.9 11.5 21.9 10.9V9C21.9 8.4 21.4 8 20.8 8C17.4 8.3 14.3 9.8 12 12.1C9.7 14.4 8.19999 17.5 7.89999 20.9C7.89999 21.5 8.29999 22 8.89999 22H10.8C11.4 22 11.8 21.6 11.9 21C12.2 18.6 13.2 16.5 14.8 14.9ZM16.2 16.3C17.4 15.1 19 14.3 20.7 14C21.3 13.9 21.8 14.4 21.8 15V17C21.8 17.5 21.4 18 20.9 18.1C20.1 18.3 19.5 18.6 19 19.2C18.5 19.8 18.1 20.4 17.9 21.1C17.8 21.6 17.4 22 16.8 22H14.8C14.2 22 13.7 21.5 13.8 20.9C14.2 19.1 15 17.5 16.2 16.3Z" fill="#035A4B"></path>
</svg>
</span>
</div>
<div class="flex-grow-1 ms-4">
<h4 class="card-title">Telegram 公告频道</h4>
<p class="card-text text-body">及时了解我们的最新动态，获取最新优惠。</p>
</div>
</div>
</div>
</a>
...
<a class="card card-transition h-100" href="https://t.me/bigme_public"  rel="noopener noreferrer">
<div class="card-body">
<div class="d-flex">
<div class="flex-shrink-0">
<span class="svg-icon text-primary">
...
<div class="flex-grow-1 ms-4">
<h4 class="card-title">Telegram 交流群组</h4>
<p class="card-text text-body">快来加入我们吧，和群友一起探索世界。</p>
</div>
</div>
</div>
</a>
...
<div class="bg-primary text-center" style="background-image: url(/assets/svg/components/shape-7.svg);">
<div class="container content-space-2">
<div class="mb-5">
<h2 class="text-white fw-light">开始试用 {{$title}}，探索新世界</h2>
</div>
<a class="btn btn-light transition-3d-hover" href="/user#/register">立即注册</a>
</div>
</div>
