...
<li class="hs-has-sub-menu nav-item">
<a id="priceMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle " hre role="button" aria-expanded="false">条款政策</a>
...
<a id="docsMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle" href="javascript:;" role="button">支持</a>

<div class="hs-mega-menu hs-position-right dropdown-menu hs-mega-menu-desktop-lg animated" aria-labelledby="docsMegaMenu" style="min-width: 20rem; max-width: 20rem; animation-duration: 300ms; display: none;">
...
<span class="navbar-dropdown-menu-media-title">使用文档 <span class="badge bg-primary rounded-pill ms-1">v1.0</span></span>
<p class="navbar-dropdown-menu-media-desc">客户端使用文档&nbsp;<i class="bi bi-exclamation-circle" data-bs-toggle="tooltip" data-bs-html="true" title="需登录状态下查看"></i></p>
</div>
</div>
</a>
